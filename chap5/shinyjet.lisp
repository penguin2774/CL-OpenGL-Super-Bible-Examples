...
(defmethod setup-RC ((w hello-window))
  ...
  (gl:light :light0 :specular specular)
  (gl:enable :light0)
  ...
  (gl:material :front :specular specref)
  (gl:material :front :shininess 0.75)
  
  (gl:clear-color 0.0 0.0 1.0 1.0)))
  ;(gl:enable :normalize))) ;; normalizing is done by the normalized-vertices macro at compile time
